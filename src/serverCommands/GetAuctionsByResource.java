...
public class GetAuctionsByResource extends ServerCommand {

	private long resource_id;
	
	GetAuctionsByResource(Connection con){
		super(con);
	}
	...
	public void run(){
	  		HashMap data = new HashMap();
			ArrayList<HashMap> auctions = new ArrayList();
			for( Auction auction : con.jAuctionServer.auctionStore.getAuctionsByResourceId(resource_id)){
				HashMap auc1 = new HashMap();
